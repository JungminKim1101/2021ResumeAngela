...
\section{PROJECTS}
    ...
    \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Developed a boarding checking gui with Java, where we search for the user's name and see what time and which plane the user is boarding. Also, everytime a user updates if they are taking the plane or not, we check if the capacity is full or not by saving the information into a server}
         \resumeItemListEnd
